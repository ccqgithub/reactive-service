var RSForm = (function (exports, rxjs) {
        ...
        const { catchError, concatAll, reduce, switchMap, concatMap, takeWhile, tap, skip, map } = rxjs__default.operators;
        ...
        class RSField {
            ...
            validateRules() {
                ...
                let hasError = false;
                return rxjs.of(...rules).pipe(concatMap((rule) => {
                    return rxjs.of('').pipe(switchMap(() => {
            ...
            validateAll() {
                return rxjs.concat(this.validateRules(), this.validateFields()).pipe(reduce((prev, cur) => prev.concat(...cur), []));
            }
        }
