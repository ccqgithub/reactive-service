(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.RSForm = {}, global.rxjs, global.rxjs.operators));
  ...
  class RSField {
      constructor(schema, options) {
          ...
          const subscription = this.validate$
              ...
              this.validating = false;
              this.errors = [...errors];
              (_a = this.waiting) === null || _a === void 0 ? void 0 : _a.resolve(errors);
              this.form.onChangeStatus();
      ...
      upTouch() {
          var _a;
          this.touched = true;
          (_a = this.parent) === null || _a === void 0 ? void 0 : _a.upTouch();
      }
      downTouch() {
          this.touched = true;
          if (this.fields) {
      ...
      upDirty() {
          var _a;
          this.dirty = true;
          (_a = this.parent) === null || _a === void 0 ? void 0 : _a.upDirty();
      }
      downDirty() {
          this.dirty = true;
          if (this.fields) {
      ...
      upValidate() {
          var _a;
          this.validate$.next();
          (_a = this.parent) === null || _a === void 0 ? void 0 : _a.upValidate();
      }
      checkValidate() {
      ...
      setSchema(schema) {
          ...
          if (Array.isArray(fields)) {
              fields.forEach((item, index) => {
                  ...
                  newFields[item.key] = Object.assign(Object.assign({}, item), { index: `${index}` });
              });
          }
          else if (typeof fields === 'object' && fields !== null) {
              Object.keys(fields).forEach((key) => {
                  newFields[key] = Object.assign(Object.assign({}, fields[key]), { key, index: key });
              });
          }
      ...
      validateRule(rule, value, source) {
          ...
          if (v$) {
              return v$.pipe(operators.map((errs) => {
