...
var State = /** @class */ (function (_super) {
    ...
    function State(initialValue) {
        ...
        _this._state$$ = new rxjs_1.BehaviorSubject(initialValue);
    ...
    State.prototype.select = function (mapFn) {
        var newValue$$ = new rxjs_1.BehaviorSubject(mapFn(this.state));
        var subscription = this._state$$
            .pipe(operators_1.map(function (state) { return mapFn(state); }), operators_1.distinctUntilChanged())
            .subscribe(newValue$$);
        this.beforeDispose(subscription.unsubscribe);
        return newValue$$;
    };
    State.prototype.selectAsObservable = function (mapFn) {
        return this._state$$.asObservable().pipe(operators_1.map(function (state) { return mapFn(state); }), operators_1.distinctUntilChanged());
    };
