(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.RSReact = {}, global.rxjs, global.React));
}(this, (function (exports, rxjs, React) { 'use strict';
        ...
        if (typeof provider === 'object') {
          ...
          const {
            useValue = undefined
                ...
                rest = __rest(p, ["useValue"]);

          record = Object.assign(Object.assign({}, rest), {
            value: useValue
          });
  ...
  */
  ...
  class Service extends Disposable {
    constructor(args = {}) {
      super(); // displayName, for debug

      this.displayName = ''; // all state

      this.$$ = new rxjs.BehaviorSubject({}); // state
